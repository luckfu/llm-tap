...
**本地透明代理：采集真实 LLM 交互，一站式筛选、检查并导出训练数据。**
...
![支持数据库下拉、时间范围和显式记录选择的调用列表](docs/screenshots/overview-en.png)

### 调用详情

![展示元数据及可折叠请求、响应和脱敏 Headers 的调用详情](docs/screenshots/detail-en.png)

### 统计概览

![按 Host、协议和模型统计的概览](docs/screenshots/stats-en.png)

### 导出所选记录

![只处理显式选择调用的训练数据导出界面](docs/screenshots/export-en.png)
